...
import L, { VectorGrid, latLng, vectorGrid } from "leaflet"
...
class Frontpage extends React.Component{
    ...
    renderJSONVT=()=>{
        ...
        L.vectorGrid.protobuf(BASE_URL_XP+"/kecamatan/{z}/{x}/{y}", {
            ...
            getFeatureId:f=>{
                const map_center=JSON.parse(f.properties.map_center)
                const lat_lng=[map_center.latitude, map_center.longitude]
            ...
            <>
                ...
                <Modal show={detail.is_open} onHide={()=>this.toggleDetail()} backdrop="static" scrollable>
                    ...
                    <Modal.Body>
                        ...
                        <p className="mt-5 mb-2">Curah hujan optimal untuk Bawang Merah adalah <strong>80-200 mm/bulan</strong></p>
                        {detail.data?.curah_hujan_status=="out_max"&&
                            <p><strong>Disclaimer :</strong> Petani tetap bisa menanam Bawang Merah diluar rekomendasi jadwal tanam dengan mengantisipasi kelebihan curah hujan di lahan dan potensi serangan OPT, dengan melakukan persiapan dan perbaikan saluran drainase</p>
                        }
                        {detail.data?.curah_hujan_status=="out_min"&&
                            <p><strong>Disclaimer :</strong> Petani tetap bisa menanam Bawang Merah diluar rekomendasi jadwal tanam, asalkan kebutuhan air irigasi dapat tetap terpenuhi menggunakan pompa, sible, atau disel</p>
                        }
                    </Modal.Body>
